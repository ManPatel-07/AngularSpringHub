...
public class CompanyController 
{
	...
	@GetMapping(path = "/byReviewId")
	public ResponseEntity<?> getCompanyByReviewId(@RequestParam("reviewId") Long id)
	{
		return new ResponseEntity<>(compnayService.getByReviewId(id), HttpStatus.OK);
	}
